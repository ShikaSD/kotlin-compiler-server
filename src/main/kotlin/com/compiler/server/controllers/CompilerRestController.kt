...
//      }
      KotlinTranslatableCompiler.SWIFT_EXPORT -> kotlinProjectExecutor.convertToComposeIr(project).let {
        // TODO: A hack to avoid changing the return type of the function.
        object : TranslationResultWithJsCode(it.generatedIr, it.compilerDiagnostics, it.exception) {}
      }
    }
  }
